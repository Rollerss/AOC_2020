    ...
    public static class Day02
    {
        public static void DoSomething()
        {
            ...
            foreach (var item in strs)
            {
                ...
                var max = int.Parse(spilt[1]);
                var letter = spilt[2].ToCharArray();
                var pass = spilt[3];

                var cnt = pass.ToCharArray().Count(c => c == letter[0]);
        ...
        public static void DoSomething2()
        {
            ...
            foreach (var item in strs)
            {
                ...
                var max = int.Parse(spilt[1]);
                var letter = spilt[2].ToCharArray();
                var pass = spilt[3].ToCharArray();

                if ((pass[min - 1] == letter[0] && pass[max - 1] != letter[0]) || (pass[min - 1] != letter[0] && pass[max - 1] == letter[0]))
                {
                    totalCount++;
                }
            }
